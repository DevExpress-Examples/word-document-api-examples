...
Namespace RichEditDocumentServerAPIExample.CodeUtils
    ...
    Public Class RichEditCSExampleCodeEvaluator
        ...
        Private Const codeStart_Renamed As String = "using System;" & ControlChars.CrLf & "using System.Text;" & ControlChars.CrLf & "using DevExpress.XtraPrinting;" & ControlChars.CrLf & "using DevExpress.XtraRichEdit;" & ControlChars.CrLf & "using DevExpress.XtraRichEdit.API.Native;" & ControlChars.CrLf & "using DevExpress.XtraRichEdit.Export;" & ControlChars.CrLf & "using DevExpress.XtraRichEdit.Import;" & ControlChars.CrLf & "using System.Drawing;" & ControlChars.CrLf & "using System.Windows.Forms;" & ControlChars.CrLf & "using DevExpress.Utils;" & ControlChars.CrLf & "using System.IO;" & ControlChars.CrLf & "using System.Diagnostics;" & ControlChars.CrLf & "using System.Xml;" & ControlChars.CrLf & "using System.Data;" & ControlChars.CrLf & "using System.Collections.Generic;" & ControlChars.CrLf & "using System.Linq;" & ControlChars.CrLf & "using System.Globalization;" & ControlChars.CrLf & "using Document = DevExpress.XtraRichEdit.API.Native.Document;" & ControlChars.CrLf & "using TableRow = DevExpress.XtraRichEdit.API.Native.TableRow;" & ControlChars.CrLf & "namespace RichEditCodeResultViewer { " & ControlChars.CrLf & "public class ExampleItem { " & ControlChars.CrLf & "        public static void Process(RichEditDocumentServer server) { " & ControlChars.CrLf & ControlChars.CrLf
    ...
    Public Class RichEditVbExampleCodeEvaluator
        ...
        Private Const codeStart_Renamed As String = "Imports Microsoft.VisualBasic" & ControlChars.CrLf & "Imports System" & ControlChars.CrLf & "Imports DevExpress.XtraRichEdit" & ControlChars.CrLf & "Imports DevExpress.XtraRichEdit.API.Native" & ControlChars.CrLf & "Imports System.Drawing" & ControlChars.CrLf & "Imports System.Windows.Forms" & ControlChars.CrLf & "Imports DevExpress.Utils" & ControlChars.CrLf & "Imports System.IO" & ControlChars.CrLf & "Imports System.Diagnostics" & ControlChars.CrLf & "Imports System.Xml" & ControlChars.CrLf & "Imports System.Data" & ControlChars.CrLf & "Imports System.Collections.Generic" & ControlChars.CrLf & "Imports System.Globalization" & ControlChars.CrLf & "Imports Document = DevExpress.XtraRichEdit.API.Native.Document" & ControlChars.CrLf & "Imports TableRow = DevExpress.XtraRichEdit.API.Native.TableRow" & ControlChars.CrLf & "Namespace RichEditCodeResultViewer" & ControlChars.CrLf & "	Public Class ExampleItem" & ControlChars.CrLf & "		Public Shared Sub Process(ByVal server As RichEditDocumentServer)" & ControlChars.CrLf & ControlChars.CrLf
