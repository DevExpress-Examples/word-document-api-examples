...
Namespace RichEditDocumentServerAPIExample.CodeExamples
	Friend Class ListsActions
		...
		Private Shared Sub CreateBulletedList(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #CreateBulletedList
		...
		Private Shared Sub CreateNumberedList(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #CreateNumberedList
		...
		Private Shared Sub CreateMultilevelList(ByVal wordProcessor As RichEditDocumentServer)
