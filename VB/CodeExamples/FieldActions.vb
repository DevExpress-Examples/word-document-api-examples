...
Namespace RichEditDocumentServerAPIExample.CodeExamples
	Friend Class FieldActions
		Private Shared Sub InsertField(ByVal wordProcessor As RichEditDocumentServer)
'			#Region "#InsertField"
...
'			#End Region ' #InsertField
		...
		Private Shared Sub ModifyFieldCode(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #ModifyFieldCode
		...
		Private Shared Sub CreateFieldFromRange(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #CreateFieldFromRange
		...
		Private Shared Sub ShowFieldCodes(ByVal wordProcessor As RichEditDocumentServer)
