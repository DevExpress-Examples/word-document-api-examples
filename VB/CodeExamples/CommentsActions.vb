...
Namespace RichEditDocumentServerAPIExample.CodeExamples
    Public Class CommentsActions
         Private Sub CreateComment(ByVal server As RichEditDocumentServer)
...
'            #End Region ' #CreateComment
         ...
         Private Sub CreateNestedComment(ByVal server As RichEditDocumentServer)
...
'            #End Region ' #CreateNestedComment
         ...
         Private Sub DeleteComment(ByVal server As RichEditDocumentServer)
...
'            #End Region ' #DeleteComment
         ...
         Private Sub EditCommentProperties(ByVal server As RichEditDocumentServer)
...
'            #End Region ' #EditCommentProperties
         ...
         Private Sub EditCommentContent(ByVal server As RichEditDocumentServer)
