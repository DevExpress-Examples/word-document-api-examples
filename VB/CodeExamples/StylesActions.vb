...
Namespace RTEDocumentServerExamples.CodeExamples
	Friend Class StylesAction
		Private Shared Sub CreateNewCharacterStyle(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #CreateNewCharacterStyle
		...
		Private Shared Sub CreateNewParagraphStyle(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #CreateNewParagraphStyle
		...
		Private Shared Sub CreateNewLinkedStyle(ByVal wordProcessor As RichEditDocumentServer)
