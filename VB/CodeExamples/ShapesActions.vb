...
'			#End Region ' #AddFloatingPicture
		...
		Private Shared Sub FloatingPictureOffset(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #FloatingPictureOffset
		...
		Private Shared Sub ChangeZorderAndWrapping(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #AddTextBox
		...
		Private Shared Sub InsertRichTextInTextBox(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #InsertRichTextInTextBox
		...
		Private Shared Sub RotateAndResize(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #RotateAndResize
		...
		Private Shared Sub SelectShape(ByVal wordProcessor As RichEditDocumentServer)
'			#Region "#SelectShape"
			Dim document As Document = wordProcessor.Document
			document.LoadDocument("Documents\Grimm.docx", DocumentFormat.OpenXml)
