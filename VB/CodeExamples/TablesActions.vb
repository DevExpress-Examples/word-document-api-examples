...
Namespace RTEDocumentServerExamples.CodeExamples
	...
	Friend Class TablesActions
		Private Shared Sub CreateTable(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #CreateTable
		...
		Private Shared Sub CreateFixedTable(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #CreateFixedTable
		End Sub
		Private Shared Sub ChangeTableColor(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #ChangeTableColor
		...
		End Class
		#End Region ' #@ChangeTableColor
		Private Shared Sub CreateAndApplyTableStyle(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #CreateAndApplyTableStyle
		...
		Private Shared Sub UseConditionalStyle(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #UseConditionalStyle
		...
		Private Shared Sub ChangeColumnAppearance(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #UseTableCellProcessor
		...
		Private Shared Sub MergeCells(ByVal wordProcessor As RichEditDocumentServer)
'			#Region "#MergeCells"
			Dim document As Document = wordProcessor.Document
...
'			#End Region ' #MergeCells
		End Sub
		Private Shared Sub SplitCells(ByVal wordProcessor As RichEditDocumentServer)
'			#Region "#SplitCells"
			Dim document As Document = wordProcessor.Document
...
'			#End Region ' #SplitCells
		End Sub
		Private Shared Sub DeleteTableElements(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #DeleteTableElements
		...
		Private Shared Sub WrapTextAroundTable(ByVal wordProcessor As RichEditDocumentServer)
