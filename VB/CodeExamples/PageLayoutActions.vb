...
Namespace RichEditDocumentServerAPIExample.CodeExamples
    Friend Class PageLayoutActions
        Private Shared Sub LineNumbering(ByVal server As RichEditDocumentServer)
...
'            #End Region ' #LineNumbering
        ...
        Private Shared Sub CreateColumns(ByVal server As RichEditDocumentServer)
...
'            #End Region ' #CreateColumns
        ...
        Private Shared Sub PrintLayout(ByVal server As RichEditDocumentServer)
'            #Region "#PrintLayout"
...
'            #End Region ' #PrintLayout
        ...
        Private Shared Sub TabStops(ByVal server As RichEditDocumentServer)
'            #Region "#TabStops"
            Dim document As Document = server.Document
            server.LoadDocument("Documents\Grimm.docx", DocumentFormat.OpenXml)
            document.Unit = DevExpress.Office.DocumentUnit.Inch
