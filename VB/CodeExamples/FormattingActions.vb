...
'			#End Region ' #ResetCharacterFormatting
		End Sub
		Private Shared Sub FormatParagraph(ByVal wordProcessor As RichEditDocumentServer)
...
'			#End Region ' #FormatParagraph
		End Sub
		Private Shared Sub ResetParagraphFormatting(ByVal wordProcessor As RichEditDocumentServer)
