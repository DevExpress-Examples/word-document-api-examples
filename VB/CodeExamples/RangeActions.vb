...
Namespace RichEditDocumentServerAPIExample.CodeExamples
    ...
    Friend Class RangeActions
        ...
        Public Shared InsertTextInRangeAction As Action(Of DevExpress.XtraRichEdit.RichEditDocumentServer) = AddressOf InsertTextInRange

        Public Shared AppendTextToRangeAction As Action(Of DevExpress.XtraRichEdit.RichEditDocumentServer) = AddressOf AppendTextToRange

        Public Shared AppendToParagraphAction As Action(Of DevExpress.XtraRichEdit.RichEditDocumentServer) = AddressOf AppendToParagraph
...
#Region "#InsertTextInRange"
            ...
            Dim range1 As DevExpress.XtraRichEdit.API.Native.DocumentRange = document.CreateRange(1, 3)
            ' Insert text into the first document range
            ' and access the range of the inserted text.
            Dim range2 As DevExpress.XtraRichEdit.API.Native.DocumentRange = document.InsertText(range1.[End], ">>NewText<<")
