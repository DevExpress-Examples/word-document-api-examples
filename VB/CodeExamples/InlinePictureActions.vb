...
Namespace RichEditDocumentServerAPIExample.CodeExamples
    Friend Class InlinePicturesActions
        Private Shared Sub ImageFromFile(ByVal server As RichEditDocumentServer)
...
'            #End Region ' #ImageFromFile
        ...
        Private Shared Sub ImageCollection(ByVal server As RichEditDocumentServer)
...
'            #End Region ' #ImageCollection
        ...
        Private Shared Sub SaveImageToFile(ByVal server As RichEditDocumentServer)
